...
public partial class DbpruebaContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__AAA5CEC219984210");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__09889210CD38FC56");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__BC1240BD60EBAA50");
